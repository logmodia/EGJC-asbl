            ...
            <tbody>
                ...
                @foreach($weektopics as $weektopic)
                    <tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
                        <td class="p-2 border-r text-base text-left">{{$weektopic->topic}}</td>
                        <td class="p-2 border-r text-base text-left">{{$weektopic->verse}}</td>
                        ...
                        <td class="p-2 border-r text-base text-left">{{\Carbon\Carbon::parse($weektopic->weekdate)->translatedFormat('l jS F Y')}}</td>
                        <td>
                            <a href="{{ Route('weektopic_edit', $weektopic->id) }}" 

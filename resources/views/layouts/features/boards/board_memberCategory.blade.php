...
@section('content1')
    ...
    <div class="table w-full p-2">
        ...
        <h3 class = "h_4 text-center">Les catégories</h3>
            ...
            <tbody>
                ...
                @foreach($memberCategories as $memberCategory)
                    <tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
                        <td class="p-2 border-r text-base text-left">{{$memberCategory->categ_name}}</td>
                        <td>
                            <a href="{{ Route('memberCategory_edit', $memberCategory->memberCateg_id) }}" 
                                class="bg-blue-500 p-2 mr-5 text-white hover:shadow-lg text-xs font-thin text-sm">
                                <ion-icon name="create"></ion-icon> Editer
                            </a>
                            <a href="{{ Route('messagebox', $memberCategory->memberCateg_id .'/'.'delete'.'/'.'memberCategory_destroy'.'/'.'memberCategory_all') }}" 
